    ...
    function deletename(){
        ...
        document.getElementById("inputparticular").type="text"
    ...
    function deleteparticular() {
        ...
        let index=JSON1.findIndex((item) => item.name === d);
        if (index === -1) {
    ...
    function deleteparticular1() {
        ...
        let index=JSON1.findIndex((item) => item.id === d);
        if (index === -1) {
            alert("Item not found.Please try again");
            reset()
        }
    ...
    function editparticular1(){
        ...
        console.log(e)
        let index=JSON1.findIndex((item)=>item.name===e)
        if(index===-1){
            alert("item not found")
        }
        else{
            editparticular(index)
        }
    ...
    function editparticular2(){
        ...
        console.log(e)
        let index=JSON1.findIndex((item)=>item.id===e)
        if(index===-1){
            alert("item not found")
        }
        else{
